...
class FinanceControllerTest < ActionController::TestCase
  ...
  test "should create finance" do
    assert_difference('Finance.count') do
      post :create, finance: { orcamento: @finance.orcamento, pagamento: @finance.pagamento }
    end
  ...
  test "should update finance" do
    patch :update, id: @finance, finance: { orcamento: @finance.orcamento, pagamento: @finance.pagamento }
    assert_redirected_to finance_path(assigns(:finance))
  end
